...
var problems_1 = require("../components/coding/mockData/problems");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            //   });
            // }
            problems_1.problemsList.forEach(function (problem, index) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, db.problem.create({
                                data: {
                                    problemNo: index + 1,
                                    problemId: problem.problemId,
                                    title: problem.title,
